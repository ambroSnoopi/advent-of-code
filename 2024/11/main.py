...
quest.blink(10000) 
print("Unique:", len(quest.stones)) #3811@1000 -> 3811@10000, it's a repeating pattern! Thus, constant performance when storing by value (i.e. using Counter)
#print("Total:" , quest.total_stones())